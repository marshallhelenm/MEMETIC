...
function GifPauseButton() {
  const {staticGifs, setStaticGifs} = useGuessy()
  ...
  return (
    <FormControlLabel control={<PurpleSwitch checked={!staticGifs}
      onChange={toggleStaticGifs} color="#907AD6" />} label="Gifs"  sx={{ color:  "#DABFFF"}} />
  )
